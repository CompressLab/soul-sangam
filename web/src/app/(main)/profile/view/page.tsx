              ...
              {interest && isIncoming && interest.status === "pending" && (
                <div className="flex gap-2">
                  <button onClick={() => respond("accepted")}
                    className="flex items-center gap-1.5 bg-green-100 text-green-700 rounded-full px-4 py-2 text-sm font-semibold hover:bg-green-200 transition">
                    <Check size={14} /> Accept
                  </button>
                  <button onClick={() => respond("declined")}
                    className="flex items-center gap-1.5 bg-red-50 text-red-600 rounded-full px-4 py-2 text-sm font-semibold hover:bg-red-100 transition">
                    <X size={14} /> Decline
                  </button>
                </div>
              )}
