...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-secondary-50 p-4">
      <div className="card w-full max-w-md p-8 flex flex-col items-center gap-6">
        {/* Logo */}
        ...
        <div className="w-full flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-full border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50"
          >
            <GoogleIcon />
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-full bg-[#1877F2] px-6 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-[#166FE5]"
          >
            <FacebookIcon />
